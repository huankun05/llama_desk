...
class ConversationsStore implements ConversationsPreferencesHost {
	...
	async importConversationsData(
		...
		overwrite = false
	): Promise<{ imported: DatabaseConversation[]; skipped: DatabaseConversation[]; updated: DatabaseConversation[] }> {
		const result = await DatabaseService.importConversations(data, overwrite);
